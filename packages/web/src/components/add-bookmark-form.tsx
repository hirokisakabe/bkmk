    ...
    <form onSubmit={handleSubmit} className="mb-6">
      <div className="flex gap-2">
        <input
          ...
          required
          disabled={isPending}
          className="min-w-0 flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-50"
        />
        <button
          type="submit"
